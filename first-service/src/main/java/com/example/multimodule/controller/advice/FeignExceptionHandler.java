...
public class FeignExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleAuthorizedException(FeignException exception, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleWrongDataException(FeignException exception, WebRequest request) {
